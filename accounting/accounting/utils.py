...
def verifycode(request):
	...
	#构造字体对象
	font = ImageFont.truetype('/usr/share/fonts/dejavu/DejaVuSansCondensed-Bold.ttf', 23)
	#构造字体颜色
...
# _FONT_PATH = accounting.settings.VERIFY_CODE_FONT_PATH  # 这个是字体的存储路径，根据实际填写
...
# 	font_types = (_FONT_PATH + 'DejaVuSansCondensed-Oblique.ttf', _FONT_PATH + 'DejaVuSansCondensed-Bold.ttf',
# 				  _FONT_PATH + 'DejaVuSans.ttf',)
...
# 	# return HttpResponse(buffered.getvalue(), 'image/png')

# def verifycode(request):
# 	verifyCode = create_verification(max_size=34, length=4)
# 	print(verifyCode)
# 	return HttpResponse(str(verifyCode[0]))